...
const NavLink: React.FunctionComponent<NavLinkProps> = (props) => {
  const linkClass = `text-white hover:text-gray-300 px-4 py-2 flex items-center text-md uppercase font-medium`;
...
const Navbar: React.FunctionComponent<NavbarProps> = (props) => {
  ...
  const socialClass =  "text-white hover:text-gray-300";
